...
void AdInterface::checkUserAgent()
{
    ...
    userAgent = QByteArray((char*)uabuf->Des().Ptr(),uabuf->Length());
    userAgent.append(" 3gpp-gba");
    delete ua;
    delete uabuf;
#elif defined(MEEGO_EDITION_HARMATTAN)
    userAgent = "Mozilla/5.0 (MeeGo; NokiaN9) AppleWebKit/534.13 (KHTML, like Gecko) NokiaBrowser/8.5.0 Mobile Safari/534.13";
#elif defined(Q_WS_MAEMO_5)
    userAgent = "Mozilla/5.0 (X11; U; Linux armv7l; en-GB; rv:1.9.2.3pre) Gecko/20100723 Firefox/3.5 Maemo Browser 1.7.4.8 RX-51 N900";
#else
