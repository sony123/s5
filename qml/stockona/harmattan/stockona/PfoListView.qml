    ...
    Rectangle {
        ...
        Label {
            ...
            text: (editMode) ? qsTr("Edit Portfolio") :
                  (syncMode) ? qsTr("Export Portfolio") :
                               qsTr("Portfolio")
...
//                            }
    ...
    SelectionDialog {
        ...
        model: ListModel {
            ListElement { name: "US Dollar";                  value: "USD" }
            ListElement { name: "Euro";                       value: "EUR" }
            ListElement { name: "Australian Dollar";          value: "AUD" }
            ListElement { name: "Canadian Dollar";            value: "CAD" }
            ListElement { name: "Pound Sterling";             value: "GBP" }
            ListElement { name: "Hong Kong Dollar";           value: "HKD" }
            ListElement { name: "Japanese Yen";               value: "JPY" }
            ListElement { name: "Indian Rupee";               value: "INR" }
            ListElement { name: "Taiwanese Dollar";           value: "TWD" }
            ListElement { name: "Mexican Peso";               value: "MXN" }
            ListElement { name: "Russian Ruble";              value: "RUB" }
            ListElement { name: "Singapore Dollar";           value: "SGD" }
            ListElement { name: "Yuan Renminbi";              value: "CNY" }
        }

        onAccepted: {
            currency = model.get(selectedIndex).value;
